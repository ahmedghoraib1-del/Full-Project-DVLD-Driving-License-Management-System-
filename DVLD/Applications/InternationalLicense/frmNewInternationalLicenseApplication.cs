...
namespace DVLD
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            lblApplicationDate.Text = SelectedLicenseID.ToString();
            
            //By Me
           // lblApplicationDate.Text = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.IssueDate.ToString();
        ...
        private void frmNewInternationalLicenseApplication_Load_1(object sender, EventArgs e)
        {
            //me
            ...
            lblCreatedByUser.Text = clsFormat.DateToShort(DateTime.Now.AddYears(1));//add one year.
