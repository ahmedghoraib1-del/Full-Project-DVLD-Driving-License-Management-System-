...
namespace DVLD
{
    public partial class frmListIInternationalLicenseApplications : Form
    {
        private DataTable _dtInternationalLicenseApplications;

        public frmListIInternationalLicenseApplications()
        {
            InitializeComponent();
        }
        ...
        private void frmListIInternationalLicenseApplications_Load(object sender, EventArgs e)
        {
        ...
        private void btnAddNewApplication_Click(object sender, EventArgs e)
        {
            ...
            frm.ShowDialog();
            //refresh
            frmListIInternationalLicenseApplications_Load(null, null);
