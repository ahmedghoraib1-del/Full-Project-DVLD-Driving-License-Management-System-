...
namespace DVLD
{
    ...
    {
        //Me
        clsLicense _IsLicenseExist = new clsLicense();
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            llShowLicenseHistory.Enabled = (clsLicense.Find(_SelectedLicenseID) != null);


            if (_SelectedLicenseID == -1 ||clsLicense.Find(_SelectedLicenseID) == null)
            ...
            ////Me
            //_IsLicenseExist.LicenseID = _SelectedLicenseID; 

            // lblLicenseID.Text = _SelectedLicenseID.ToString();

            //llShowLicenseHistory.Enabled = (_IsLicenseExist.DriverID != -1);
            ...
            //if (_IsLicenseExist.DriverInfo.PersonID == -1)
            //{
            //    return;
            //}
